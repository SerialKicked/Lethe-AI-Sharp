...
namespace AIToolkit.Files
{
    public class LLMSettings : BaseFile
    {
        ...
        public bool DisableThinkingPrompt { get; set; } = false;

        /// <summary> Thinking models only, will move all RAG and WI to the thinking block </summary>
        public bool PutRAGInThinkingPrompt { get; set; } = false;

        public bool ForceRAGInSysPrompt { get; set; } = false;
        ...
        public int EmbeddingSize { get; set; } = 1024;
