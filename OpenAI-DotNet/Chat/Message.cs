...
namespace OpenAI.Chat
{
    public sealed class Message
    {
        ...
        /// <summary>
        /// The chain-of-thought / reasoning content emitted by the model as a separate
        /// field (compatible with llama.cpp, vLLM, and similar OpenAI-compatible backends
        /// that surface thinking blocks as their own JSON property).
        /// </summary>
        [JsonInclude]
        ...
        internal void AppendFrom(Delta other)
        {
            ...
            if (!string.IsNullOrEmpty(other?.ReasoningContent))
            {
                ReasoningContent = (ReasoningContent ?? string.Empty) + other.ReasoningContent;
            }
